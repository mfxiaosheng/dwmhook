...
//		}
//
//		printf( "name: %s  address:%x  value: %d\n\n", bstrName, offset, dwValue);
//	}
//}
//int  test()
//{
//	FILE* pFile;
//#define OPEN_FILE_NAME L"C:\\symbols\\dxgi.pdb\\013A571D9173429CA2C47576F771B5411\\dxgi.pdb"
//
//
//	if (_wfopen_s(&pFile, OPEN_FILE_NAME, L"r") || !pFile) {
...
//  //  DumpAllTypes(g_pGlobalSymbol);
//  //  DumpAllGlobals(g_pGlobalSymbol);
//  //  GetValueInfo(g_pGlobalSymbol);
//
//	// release COM objects and CoUninitialize()
//   // GetClassInfo1(g_pGlobalSymbol);
//	Cleanup();
//    getchar();
//    return 0;
//}
//////////////////////////////////////////////////////////////
////
//int wmain11(int argc, wchar_t *argv[])
//{
//
//    test();
//
...
//
//  if (FAILED(hr)) {
//    AddToLog(L"CoCreateInstance failed - HRESULT = %08X\n", hr);
//
//    return false;
//  }
//
...
//
//    if (FAILED(hr)) {
//      AddToLog(L"loadDataFromPdb failed - HRESULT = %08X\n", hr);
//
//      return false;
//    }
//  }
...
//
//    if (FAILED(hr)) {
//      AddToLog(L"loadDataForExe failed - HRESULT = %08X\n", hr);
//
//      return false;
//    }
//  }
...
//
//  if (FAILED(hr)) {
//    AddToLog(L"openSession failed - HRESULT = %08X\n", hr);
//
//    return false;
//  }
//
...
//
//  if (hr != S_OK) {
//    AddToLog(L"get_globalScope failed\n");
//
//    return false;
//  }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-line'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-compiland'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-type'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-label'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-sym'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-lsrc'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-ps'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-psr'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-maptosrc'");
//
//      return false;
//    }
//
...
//
//    else {
//      AddToLog(L"ERROR - ParseArg(): missing argument for option '-mapfromsrc'");
//
//      return false;
//    }
//
...
//
//  else {
//    AddToLog(L"ERROR - unknown option %s\n", argv[0]);
//
//    PrintHelpOptions();
//
//    return false;
...
//
//	WCHAR buff[4096]{ };
//    vswprintf(buff, sizeof(buff), fmt, va);
//    
//	va_end(va);
//
//	FILE* f = nullptr;
...
//      AddToLog(L"ERROR - Failed to get the compiland's name\n");
//
//      pCompiland->Release();
...
//
//    else {
//       /* if (StrStrW(bstrName,L"CDXGISwapChainDWMLegacy>::`vftable'") == 0)
//        {
//            AddToLog(L"%s\n\n", bstrName);
//        }*/
//      AddToLog(L"%s\n\n", bstrName);
...
//
//    else {
//      AddToLog(L"ERROR - DumpAllGlobals() returned no symbols\n");
//
//      return false;
//    }
//  }
...
//    AddToLog(L"ERROR - DumpAllUDTs() returned no symbols\n");
//
//    return false;
//  }
//
...
//    AddToLog(L"ERROR - DumpAllEnums() returned no symbols\n");
//
//    return false;
//  }
//
...
//    AddToLog(L"ERROR - DumpAllTypedefs() returned no symbols\n");
//
//    return false;
//  }
//
...
//    AddToLog(L"ERROR - DumpAllOEMs() returned no symbols\n");
//
//    return false;
//  }
//
...
//  }
//
//  AddToLog(L"    RVA        Address       Size    Module\n");
//
//  IDiaSectionContrib *pSecContrib;
//  ULONG celt = 0;
//
...
//    AddToLog(L"ERROR - DumpInjectedSources() could not find %s\n", szName);
//
//    return false;
//  }
//
...
//
//      AddToLog(L"ERROR - DumpFPO() frameByRVA invalid RVA: 0x%08X\n", dwRVA);
//
//      pEnumFrameData->Release();
//
//      return false;
...
//
//  else {
//    AddToLog(L"ERROR - DumpFPO() GetTable\n");
//
//    return false;
//  }
//
...
//    AddToLog(L"ERROR - DumpFPO() findChildren could not find symol %s\n", szSymbolName);
//
//    return false;
//  }
//
...
//
//        if (pCompiland->get_name(&bstrName) == S_OK) {
//          AddToLog(L"Compiland = %s\n", bstrName);
//
//          SysFreeString(bstrName);
//        }
//
//        else {
//          AddToLog(L"Compiland = (???)\n");
//        }
//
//        IDiaEnumLineNumbers *pLines;
//
...
//      }
//
//      AddToLog(L"image rva = %08X ==> source rva = %08X\n\nRelated OMAP entries:\n", dwRVA, dwRVATo);
//      AddToLog(L"image rva ==> source rva\n");
...
//      }
//
//      AddToLog(L"source rva = %08X ==> image rva = %08X\n\nRelated OMAP entries:\n", dwRVA, dwRVATo);
//      AddToLog(L"source rva ==> image rva\n");
//      AddToLog(L"%08X  ==> %08X\n", datasav.dwRVA, datasav.dwRVATo);
//
//      i = 0;
//
...
//    AddToLog(L"ERROR - GetTable() getEnumTables\n");
//
//    return E_FAIL;
//  }
//
